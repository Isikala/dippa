...
Old X-ray methods used to be destructive but newer methods for 
example one used in ITRAX are not. ITRAX is half core analysis scanner where core half is 
