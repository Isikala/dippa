...
%tähän kuvat Faradayn ja  Guoyn mittareista.
...
when sample is put into other coil it causes its indunductance to change and the difference in inductances indicates
...
working temperature 4.2K for example in liquid helium\cite{Marcon2012}. It's extreme accuracy is based on measuring changes 
one flux quantum related magnetic fields\cite{Marcon2012}.
