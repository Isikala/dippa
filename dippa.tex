...
%\begin{figure}[ht]
%  \begin{center}
%    \includegraphics[width=9cm]{diamonddrill.jpg}
%    \caption{Example of a diamond drill.}
%    \label{fig:ddrill}
%  \end{center}
%\end{figure}
...
afterwards. Nondestructive methods do not affect the structure of the core so the do not limit the 
...
usually heated to speed the process. Next different procedures are conducted to find out minerals that the sample
contains. This can include colorimetric, volumetric and gravimetric measurements.\cite{Klein1993}

In gravimetric analysis product produced in chemical reaction is weighted. Regents for solution are chose
so that precipitation happens and this way some for precipitated substance can be weighted and amount of certain 
one mineral may be determined. This is slow and often complicated process and new faster methods have been 
researched.\cite{Klein1993}

Atomic absorption spectroscopy (AAS) is one of the newer methods. In this method solution is steamed and light is 
directed through the steam to spectrometer. When absorption of the light in the steam is studied with spectrometer
mineral contents of the sample may be examined. This method was first used in 1950s. It was quickly approved by wet 
chemists because it was fairly fast and gave good results compared to the older wet methods. \cite{Klein1993}

Old X-ray methods used to be destructive when sample was ground into find powder before it was put into pellets
and moved through X-ray scanner. Newer methods do not require such extensive destruction of the sample one
example is ITRAX. ITRAX is half core analysis scanner where core half is 
...
%\begin{figure}[ht]
%  \begin{center}
%    \includegraphics[width=9cm]{Itrax.jpg}
%    \caption{ITRAX}
%    \label{fig:Itrax}
%  \end{center}
%\end{figure}
...
$\chi$ = $\frac{\kappa}{\rho}$ 
\end{equation}
All substances may be categorized by their magnetic properties. Ferromagnetic minerals remember 
magnetic field that was applied on them by being able to contain a magnetic remanence. Good examples of 
...
%\begin{figure}[ht]
%  \begin{center}
%    \includegraphics[width=9cm]{LPSmeasurement.jpg}
%    \caption{Loop, point and sample measurement devices.}
%    \label{fig:Josep}
%  \end{center}
%\end{figure}
