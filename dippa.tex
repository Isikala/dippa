...
core has passed the sensor. By superimposing the core logs after the previous core with core log of the following
core part good results may be acquired. This would leave only small part of the measurement at the beginning and at
end of the core sample air-biased \cite{Nowaczyk2001}:.
