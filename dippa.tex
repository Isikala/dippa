...
through them. The best performance is aquired when loop sensor has radius close to the core radius. According to the 
...
error was proposed. Following core parts may be moved together so there is no gap between them. This might be problematic because sometimes core parts have caps in their both ends thus preventing this. Other option proposed
