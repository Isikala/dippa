...
readings. One of the benefits of the point sensor is that measurement point may be selected on intact spot of the
core plug. Sometimes core is damaged by the drilling process and in whole core logging damaged portion cannot be 
dodged this way. Also because the sensor takes readings from such a small area the errors caused in the ends of the
core plug are very small and do not require extra attention.\cite{Nowaczyk2001}:
