...
example ITRAX \cite{Croudace2006} are not. Itrax is half core analysins method where core half is 
driven by a motor through an X-ray and then optical and X-radiographic values are recorded. 
this provides resolution up to 200 μm.
