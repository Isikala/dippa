...
Point sensors perform better when used on half core samples. The measurements are taken on straight surface cut of the core
taking the measurement from round side of the core half causes errors in readings.
