...
measurement apparatus types for continious measurements are loop sensors and point sensors. Loop sensors are loop
like systems and they measure the magnetic susceptibility by the change in magnetic flux when full core is move
through them. The best performance is aguired when loop sensor has radius close to the core radius. According to the 
research\cite{}: it is also important to analyse 
