...
This chapter introduces different core logging methods and how core samples are attained. 
Magnetic susceptibility measurements are discussed in dept.

\section{Core Logging Measurements}
...
usually  hold a core lenght of 1,5 to 3 metres. When the inner tube is filled with rock it is brought
...
After core has been extracted from the rock geologists give it a brief visual analysis for lithological
changes that can be seen by hand lenses or handheld microscope. Wet cuttings have to be cleaned before
intial examination.
