...
Old X-ray methods used to be destructive when they affected grain structure of the core \cite{Croudace2006} but
newer methods for example ITRAX \cite{Croudace2006} are not. 
